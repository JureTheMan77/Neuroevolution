...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Pristop \enquote{random forest} je dosegel enako točnost (tabela~\ref{tab:rforest_wine_result}).
    ...
    pristopu \enquote{random forest}.
    ...
    \chapter{Dodatek}\label{ch:dodatek}
    \input{dodatek}
