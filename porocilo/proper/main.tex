...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    podatkovne množice, izračuna njihovo kvaliteto na podlagi točnosti ali Matthewsovega korelacijskega koeficienta s pribitkom kompleksnosti,
    ...
    ~\cite{inteligentni_sistemi_2010_ga,genetic_algorithm_wiki_2022}.
    ...
    Splošna psevdokoda genetskih algoritmov je naslednja~\cite{inteligentni_sistemi_2010_evolucijsko_racunanje}:
    ...
    \begin{itemize}
        ...
        \item izračun kvalitete (razdelek~\ref{sec:izracun-kakovosti}) agentov na podlagi točnosti in Matthewsovega korelacijskega koeficienta
    ...
    Eno globoko vozlišče smatramo kot najmanjšo mirujočo strukturo.
    ...
    \begin{description}
        ...
        \item[Prispevek kompleksnosti]{Decimalna vrednost, ki je lahko negativna ali pozitivna.\ Vpliva na izračun kvalitete agenta v razdelku~\ref{sec:izracun-kakovosti}.
    ...
    Prednost algoritma SUS~\cite{inteligentni_sistemi_2010_sus} je manjša varianca glede na funkcijo kvalitete od metod izbire v razdelku~\ref{sec:genetski-algoritmi}.
    ...
    \begin{enumerate}
        ...
        \item V potomcu ustvarimo presek globokih vozlišč obeh staršev, ostala pa s $50\%$ možnostjo.
        Dve vozlišči obravnavamo kot enaki, če imata enak indeks.
        \item V potomcu ustvarimo presek povezav obeh staršev, ostale pa s $50\%$ možnostjo.
    ...
    Kvaliteti nato prištejemo oz.\ odštejemo prispevek inicializacijskega parametra \enquote{prispevek kompleksnosti} na naslednji način:
    \begin{equation}
        \text{Kvaliteta}=
        \begin{cases}
    ...
    Strukture, ki so z algoritmom propagiranja nedosegljive, ne vplivajo na kvaliteto agentov.
        ...
        \item[A: 6.6, B:5.8, C: 2.2]{Pravilen razred: $0$
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{||c c c c||}
                    ...
                    \hline
                \end{tabular}
                \caption{Stanje matrike zmot po propagaciji druge vrstice izmišljene učne množice. Povečali smo celico 0,1.}
        ...
        \item[A: 3.6, B:5.3, C: 3.5]{Pravilen razred: $0$
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{||c c c c||}
                    ...
                    \hline
                \end{tabular}
                \caption{Stanje matrike zmot po propagaciji tretje vrstice izmišljene učne množice. Povečali smo celico 0,1.}
        ...
        \item[A: 3.8, B:8, C: 6.8]{Pravilen razred: $1$
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{||c c c c||}
                    ...
                    \hline
                \end{tabular}
                \caption{Stanje matrike zmot po propagaciji četrte vrstice izmišljene učne množice. Povečali smo celico 1,1.}
    ...
    Rezultati in diskusije se predstavljeni v poglavju~\ref{ch:rezultati}.
    ...
    \begin{itemize}
        ...
        \item podatkovna množica Car Evaluation (podrazdelek~\ref{subsec:car-evaluation}), kjer je cilj klasificirati avtomobile v štiri kvalitetne razrede,
    ...
    \begin{table}[H]
        ...
        \end{tabular}
        \caption{Porazdelitev primerov množice Iris.}
        \label{tab:iris_opis}
    \end{table}
    ...
    \begin{table}[H]
        ...
        \end{tabular}
        \caption{Porazdelitev primerov množice Wine.}
        \label{tab:wine_opis}
    \end{table}
    ...
    \begin{table}[H]
        ...
        \end{tabular}
        \caption{Porazdelitev primerov množice Car Evaluation.}
        \label{tab:car_opis}
    \end{table}
    ...
    Učna vsebuje 43500 primerov, testna pa 14500.
    Distribucija primerov učne in testne množice je naslednja:
    \begin{table}[H]
        \centering
        \begin{tabular}{||c c c||}
            \hline
            ...
            \hline
        \end{tabular}
        \caption{Porazdelitev primerov učne in testne množice Shuttle.}
    ...
    \begin{enumerate}
        ...
        \item v vsaki generaciji smo zabeležili podatke o točnosti ali MCC agentov glede na izbrano metriko kvalitete na učni množici,
        ...
        \item od vseh zagonov za posamezni nabor smo vizualizirali najboljšega agenta s pomočjo odprtokodne knjižnice \enquote{force-graph}~\cite{Vasturiano},
        hkrati pa izdelali graf točnosti oz.\ MCC po generacijah na učni množici,
    ...
    To poglavje vsebuje povzetke rezultatov podatkovnih množic, pridobljenih po načrtu iz razdelka~\ref{sec:nacrt-poskusov}.
    ...
    Najboljše mreže drugega in tretjega nabora parametrov so večje (največja vsebuje 1 globoko vozlišče in 12 povezav),
    dosežejo pa enako oz.\ podobno natančnost.
    Vzrok so kompleksnejši agenti začetne populacije.

    Razlika med metrikama kvalitete je vidna v grafih skozi generacije.
    ...
    Iz grafov točnosti in MCC skozi generacije so razvidni tudi \enquote{preboji} v kvaliteti, predvsem na sliki~\ref{fig:iris_acc_1},
    kjer je polovica populacije do generacije 60 lahko pravilno napovedala le enega ali dva od treh razredov.
    Povprečna kvaliteta generacije je sicer rasla približno linearno.
    Vzrok za tako obtičanje kvalitete v lokalnih maksimumih je, da v fazi vzorčenja ne izbiramo samo najboljših agentov,
    kar pripelje do počasnejšega širjenja kvalitetnih lastnosti (topologije, uteži, povezav\ldots) skozi populacijo.
    Povzroči tudi širjenje manj kvalitetnih lastnosti, kar je vidno na sliki~\ref{fig:iris_acc_3} med generacijama 100 in
    120 s padcem kvalitete najslabših $30\%$ agentov.

    Vzrok za tako obtičanje kvalitete so tudi lastnosti najboljših agentov, ki jih naš način križanja ne more prenesti
    ...
    Pristop naključnih dreves je dosegel točnost $100\%$ (tabela~\ref{tab:rforest_iris_result}).
    ...
    Vzrok za tako optimizacijo mrež je večje število generacij, kjer je večja možnost za odstranitev povezav z majhno utežjo.

    Pri najboljši mreži drugega nabora parametrov je prišlo do preboja kvalitete okoli generacije 70, v generaciji 220
    ...
    Pristop naključnih dreves je dosegel enako točnost (tabela~\ref{tab:rforest_wine_result}).
    ...
    Razlog je, da so v zgodnjih generacijah najkvalitetnejši tisti agenti, ki lahko napovedujejo v večinski razred.
    ...
    Ko obravnavamo množice z zelo neenakomerno porazdelitvijo, so v začetnih generacijah najkvalitetnejši le agenti, ki
    ...
    imajo majhno izračunano kvaliteto, kar pomeni sorazmerno majhno možnost izbire v fazi križanja.
    ...
    Točnost povzroči zelo hitro konvergenco populacije na točnost večinskega razreda, nato pa zelo počasno bližanje kvalitete
    najboljšemu agentu.\ Populacija je v primeru drugega nabora parametrov ostala na točnosti večinskega razreda.
    MCC je povzročil postopno višanje kvalitete populacije sorazmerno z najboljšim agentom s konvergenco.
    ...
    Pristop naključnih dreves je dosegel precej večjo točnost $95.9\%$ s 300 drevesi (tabela~\ref{tab:rforest_car_result}).


    \section{Shuttle}\label{sec:rezultati-shuttle}
    Rezultati vsebujejo značilnosti testiranj programa na zgornjih treh množicah.
    Prisotni so preboji pri obeh metrikah kvalitet, nepovezana vhodna vozlišča in nezmožnost pravilnega napovedovanja vseh sedmih
    razredov.

    Vsi agenti pravilno napovedujejo tri največje razrede \enquote{Rad Flow}, \enquote{High} in \enquote{Bypass}, trije
    ...
    Pristop naključnih dreves je dosegel točnost $100\%$ (tabela~\ref{tab:rforest_shuttle_result}).
    ...
    Genetski algoritem pri izračunu kvalitete upošteva tudi računsko kompleksnost nevronskih mrež z nastavljivim inicializacijskim parametrom.
    ...
    Izračun bi lahko prilagodili tako, da bi v celotni populaciji preverili zmožnost napovedovanja vseh razredov,
    ...
    Namesto najboljšega agenta po zaključku programa bi za napovedovanje lahko uporabili tudi najboljšo polovico ali četrtino
