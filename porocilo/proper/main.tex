...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Algoritem NEAT (Neuroevolution of Augmenting Topologies)~\cite{enwiki:1179705451,Iba_2018_neat} je način implementacije nevroevolucije, ki spreminja topologijo in uteži povezav direktno kodiranih mrež.
    ...
    Prednost algoritma SUS~\cite{inteligentni_sistemi_2010_sus} je manjša varianca glede na funkcijo kakovosti od metod izbire iz razdelka~\ref{sec:genetski-algoritmi}.
    ...
    \begin{enumerate}
        ...
        \begin{figure}[H]
            ...
            \end{tikzpicture}
            \caption{Prvi korak propagiranja.}
