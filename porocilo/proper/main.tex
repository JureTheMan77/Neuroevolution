...
% zahvala
    ...
    \noindent
    Zahvaljujem se svojemu mentorju in šefu za njuno potrpežljivost.
    \rm\normalfont
...
%\noindent\textbf{Povzetek:}
    ...
    kompleksnost mrež.
    Točnosti ustvarjenih mrež za klasifikacijo podatkovnih množic z enakomerno porazdelitvijo razredov je primerljiva
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Naš pristop izdela nevronsko mrežo za poljubno učno množico z zveznimi ali diskretnimi atributi, s ciljem večrazredne klasifikacije.
    ...
    Eno nepovezano globoko vozlišče lahko razumemo kot najmanjšo možno mirujočo strukturo.
    ...
    \begin{description}
        ...
        \item[Največje število globokih vozlišč]{Pozitivno celo število, ki do\-lo\-ča naj\-ve\-čje število globokih vozlišč agentov.
        ...
        \item[Največje število povezav]{Pozitivna celoštevilska vrednost, ki določa naj\-ve\-čje število povezav
        ...
        \item[Največje število prečkanj]{Pozitivno celo število, ki določa največje šte\-vi\-lo prečkanj povezav.
    ...
    \begin{enumerate}
        \item Poišče agenta z največjo kakovostjo, izračunano v koraku izračuna kakovosti (razdelek~\ref{sec:izracun-kakovosti}), kjer je
        lahko upoštevana tudi njegova kompleksnost poleg izbrane metrike.
    ...
    \begin{description}
        \item[Dodajanje globokega vozlišča]{Dodamo novo globoko vozlišče z novo na\-klju\-čno vhodno in izhodno povezavo, če
    ...
    Diskusija se nahaja v poglavju~\ref{ch:rezultati}, rezultati testiranja pa v dodatku~\ref{ch:rezultati-testiranja}.
    ...
    \chapter{Diskusija rezultatov}\label{ch:rezultati}
    ...
    MCC je povzročil višanje kakovosti populacije sorazmerno z najboljšim agentom s postopno konvergenco.
