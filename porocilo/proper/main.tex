...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    V poglavju~\ref{ch:rezultati} se nahajajo diskusija in povzetek rezultatov testiranja, podrobni rezultati pa so predstavljeni v dodatku~\ref{ch:rezultati-testiranja}.
    ...
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}[node distance={30mm}, thin, main/.style = {draw, circle}]
            \node[main] (i0) {$i_0$};
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[node distance={30mm}, thin, main/.style = {draw, circle}]
            ...
            \draw[->, very thick] (d1) -- node[midway, above, sloped, pos=0.5] {0.08, 5} (d0);
        \end{tikzpicture}
        \caption{Primer agenta z mirujočo strukturo (odebeljeno). Nevronski mreži slike~\ref{fig:skica_agenta} smo odstranili povezavi
    ...
    \begin{enumerate}
        ...
        \begin{figure}[H]
            \centering
            \begin{tikzpicture}[node distance={30mm}, thin, main/.style = {draw, circle}, thicc/.style = {draw, circle, very thick}]
                \node[thicc] (i0) {$5.7$};
