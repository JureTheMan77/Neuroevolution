...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    V poglavju~\ref{ch:rezultati} se nahajajo diskusija in povzetek rezultatov testiranja, podrobni rezultati pa v dodatku~\ref{ch:rezultati-testiranja}.
    ...
    \begin{figure}[H]
        \begin{center}
            \includesvg[width=10cm]{diagram-mreza.svg}
        \end{center}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[node distance={25mm}, thin, main/.style = {draw, circle}]
            ...
            \node[main] (d0) [right of=i0] {$d_0$};
            \node[main] (d1) [right of=i1] {$d_1$};
            \node[main] (d2) [right of=d1] {$d_2$};
            \node[main] (o0) [above right of=d2] {$o_0$};
            \node[main] (o1) [below right of=d2] {$o_1$};
            \draw[->] (i0) -- node[midway, above, sloped, pos=0.5] {0.02, 1} (d0);
            \draw[->] (i1) -- node[midway, above, sloped, pos=0.5] {0.41, 1} (d1);
            \draw[->] (i2) -- node[midway, above, sloped, pos=0.5] {0.11, 1} (d1);
            \draw[->] (i2) -- node[midway, above, sloped, pos=0.5] {0.36, 1} (o1);
            \draw[->, very thick] (d0) -- node[midway, above, sloped, pos=0.5] {0.58, 5} (d2);
            \draw[->, very thick] (d2) -- node[midway, above, sloped, pos=0.5] {0.23, 5} (d1);
            \draw[->, very thick] (d1) -- node[midway, above, sloped, pos=0.5] {0.08, 5} (d0);
            \draw[->] (d2) -- node[midway, above, sloped, pos=0.5] {0.34, 1} (o0);
            \draw[->] (d2) -- node[midway, above, sloped, pos=0.5] {1.00, 1} (o1);
        \end{tikzpicture}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[node distance={25mm}, thin, main/.style = {draw, circle}]
            ...
            \node[main] (i1) [below of=i0] {$i_1$};
            \node[main] (i2) [below of=i1] {$i_2$};
            \node[main, very thick] (d0) [right of=i0] {$d_0$};
            \node[main, very thick] (d1) [right of=i1] {$d_1$};
            \node[main, very thick] (d2) [right of=d1] {$d_2$};
            \node[main] (o0) [above right of=d2] {$o_0$};
            \node[main] (o1) [below right of=d2] {$o_1$};
            \draw[->, very thick] (i0) -- node[midway, above, sloped, pos=0.5] {0.02, 1} (d0);
            \draw[->, very thick] (i1) -- node[midway, above, sloped, pos=0.5] {0.41, 1} (d1);
            \draw[->, very thick] (i2) -- node[midway, above, sloped, pos=0.5] {0.11, 1} (d1);
            \draw[->] (i2) -- node[midway, above, sloped, pos=0.5] {0.36, 1} (o1);
            \draw[->, very thick] (d0) -- node[midway, above, sloped, pos=0.5] {0.58, 5} (d2);
            \draw[->, very thick] (d2) -- node[midway, above, sloped, pos=0.5] {0.23, 5} (d1);
            \draw[->, very thick] (d1) -- node[midway, above, sloped, pos=0.5] {0.08, 5} (d0);
        \end{tikzpicture}
        \caption{Primer agenta z mirujočo strukturo. Nevronski mreži slike~\ref{fig:skica_agenta} smo odstranili povezavi
        med $d_2$ in $o_0$ ter $o_1$. Posledično na vrednost izhodnih vozlišč vpliva samo $i_2$.}
        \label{fig:mirujoca_struktura}
    \end{figure}
    ...
    največji množici Shuttle pa z 22 povezavami in enim globokim vozliščem (slika~\ref{fig:wine_acc_2_g}).
    ...
    Primer je najtočnejši agent tretjega nabora množice Wine, ki uporabi le 7 od 13 vhodnih vozlišč.

    Za naš pristop so značilni \enquote{preboji} kakovosti, kjer velika večina populacije obtiči v lokalnem minimumu,
    nato pa se kakovostne podstrukture grafov hitro prenesejo v slabše agente.
    Lahko se tudi zgodi, da do tega preboja ne pride do dodeljenega števila generacij, posledično pa ima najboljši agent nizko kvaliteto.
    ...
    Razlika pa je v tem, da je konvergenca populacije velikokrat počasnejša.
