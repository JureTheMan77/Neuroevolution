...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    To poglavje pokriva ovrednotenje programa na nekaj podatkovnih množicah (Iris, Wine, Car Evaluation in Statlog (Shuttle)) ter predstavitev rezultatov.
    ...
    \begin{itemize}
        ...
        \item podatkovna množica Statlog (Shuttle) (podrazdelek~\ref{subsec:statlog-shuttle}) s 58000 vrsticami, od katerih okoli 80\% pripada enemu razredu,
    \end{itemize}
    ...
    Vsebuje šest zveznih in dva diskretna atributa:
    \begin{itemize}
        \item čas, ko so bile meritve zabeležene,
        \item rad flow,
        \item fpv close,
        \item fpv open,
        \item high (0 ali 1),
        ...
        \item bpv open.
    \end{itemize}
    Cilj je napovedati razred od 1 do 7.
    ...
    \begin{enumerate}
        ...
        \item inicializacijske parametre populacije smo določili za vsako množico posebej glede na njeno kompleksnost,
        \footnote{Števila vhodnih in izhodnih vozlišč in seznama label atributov in razredov med nabori nismo spreminjali, ker so ti parametri določeni s strukturo podatkovnih množic.},
    ...
    Razdelek vsebuje rezultate testiranj programa na zgoraj opisanih podatkovnih množicah po načrtu poglavja~\ref{sec:nacrt-poskusov}.
    ...
    \section{Diskusija rezultatov}\label{sec:diskusija-rezultatov}
    \textbf{TODO}
