...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}[node distance={35mm}, thin, main/.style = {draw, circle}]
            \node[main] (i0) {$i_0$};
    ...
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}[node distance={33mm}, thin, main/.style = {draw, circle}]
            \node[main] (i0) {$i_0$};
            \node[main] (i1) [below of=i0] {$i_1$};
            \node[main] (i2) [below of=i1] {$i_2$};
            \node[main, very thick] (d0) [right of=i0] {$d_0$};
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[node distance={35mm}, thin, main/.style = {draw, circle}]
            ...
            \draw[->, very thick] (d2) -- node[midway, above, sloped, pos=0.5] {0.23, 5} (d1);
            \draw[->, very thick] (d1) -- node[midway, above, sloped, pos=0.5] {0.08, 5} (d0);
            \draw[->, very thick] (d2) -- node[midway, above, sloped, pos=0.5] {0.34, 1} (o0);
            \draw[->, very thick] (d2) -- node[midway, above, sloped, pos=0.5] {1.00, 1} (o1);
        \end{tikzpicture}
    ...
    \begin{enumerate}
        ...
        \begin{figure}[H]
            \centering
            \begin{tikzpicture}[node distance={35mm}, thin, main/.style = {draw, circle}, thicc/.style = {draw, circle, very thick}]
                \node[thicc] (i0) {$5.7$};
